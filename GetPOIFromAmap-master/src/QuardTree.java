...
public class QuardTree {
	...
	//输入坐标范围为WGS-84坐标系
	static double lux = 118.33022110713;//上X
	static double luy = 25.047125496573;//左上Y
	static double rdx = 120.33022110713;//右下X
	static double rdy = 27.047125496573;//右下Y
	
	static String[] type = {"090100","090101",
			"090102","0902","0903","0904",
			"0905","0906","0907"};//type和keyword必须二选一输入参数，这里选择type
	static String citycode = "0591";//城市编码
